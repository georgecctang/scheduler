...
import { render, cleanup, waitForElement, fireEvent, getByText, getAllByTestId, getByAltText,  getByTestId, queryByText, queryByAltText } from "@testing-library/react";
...
describe("Application test", () => {
  ...
  it("loads data, cancels an interview and increase the spots remaining for Monday by 1", async () => {
    ...
    // 4. Check that the element with the "Are you sure you would like to delete?" is displayed.
